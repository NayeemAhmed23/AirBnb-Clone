...
<ul class="details-list">
    <li><img src="./Assests/Icon1.png" alt="">Entire Home
        <span>You will have the entire flat for you.</span>
    </li>
    <li><img src="./Assests/Icon2.png" alt="">Enhanced Clean
        <span>This host has committed to AirBnB's cleaning process.</span>
    </li>
    <li><img src="./Assests/Icon3.png" alt=""Self checks-in
        <span>Check yourself in with keypad</span>
    </li>
    <li><img src="./Assests/calendar.png" alt="">Easy cancellation
...
<div class="map">
        ...
        <div class="host">
            <img src="./Assests/Avatar Base.png">
            <div>
